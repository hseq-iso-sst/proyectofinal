<?php 
    ...
    require_once('../../../models/aprend/visita/consultasRequisitos.php');
    require_once('../../../controllers/aprend/visita/cargarRequisitos.php');
                ...
                <div class="row justify-content-center body-empresa shadow">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center p-0 mt-3 mb-2">
                        ...
                        <h2 id="heading">VISITA <?php echo $nro_visita;?></h2>
                            ...
                            <form  action="../../../controllers/aprend/visita/insertarEvaluacion.php" method="POST" enctype="multipart/form-data" id="msform"> 
