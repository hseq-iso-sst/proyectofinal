                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="../../../indexapre.php" class="text-muted">Home</a></li>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 form-group">
                                    <div class="hpanel">
                                        <div class="panel-body-user shadow">
                                            <form action="../../../controllers/instruc/visita/insertarVisita.php" id="loginForm" method="POST" enctype="multipart/form-data">
