...
class consultasVisita{
    ...
    public function insertarVisita($id_auditoria, $id_user, $nro_visita, $fecha_ini, $fecha_fin){
        ...
        if ($f) {
            ...
            echo '<script>location.href="../../../views/aprend/visita/visitas.php"</script>';
        }else{     
            $modelo = new Conexion();
                $conexion = $modelo->get_conexion();
                ...
                if (!$statement) {
                    ...
                    echo '<script>location.href="../../../views/aprend/visita/visita1.php?nro_visita='.$nro_visita.'&id_auditoria='.$id_auditoria.'&id_visita='.$conexion->lastInsertId().'"</script>';
                }
    ...
    public function cargarVisitas(){
     ...
     public function editarVisita($id_visita,$id_auditoria, $id_user, $nro_visita, $fecha_ini, $fecha_fin){
        ...
        if (!$statement) {
            ...
            echo '<script>location.href="../../../views/aprend/visita/ver-visitas.php"</script>';
        }
