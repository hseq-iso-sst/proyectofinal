...
if (isset($_GET['id_auditoria'])){
 ...
 foreach($result as $f){
     echo'
      <form action="../../../controllers/aprend/auditoria/modificarAuditoria.php" id="loginForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="text-center">
                ...
                <a href="../principal/indexapre.php" type="submit" class="btn btn-danger">Cancelar</a>
            </div>
            </div>
             </form> 
     ';
