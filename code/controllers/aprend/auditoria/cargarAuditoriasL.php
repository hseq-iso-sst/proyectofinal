...
function cargarAuditori(){
    ...
    foreach($result as $f){
        ...
        <td>'.$f["status"].'</td>
        <td class="icono"><a href="../../../views/aprend/visita/visitas.php?id_auditoria='.$f["id_auditoria"].'" class="fas fa-edit"></a></td>
        <td class="icono"><a href="../../../views/aprend/auditoria/edit.php?id_auditoria='.$f["id_auditoria"].'" class="fas fa-edit"></a></td>
